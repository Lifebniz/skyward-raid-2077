...
const game = {
  ...
  recordEndlessPlayerDamage(amount) {
    ...
    if (!this.endless || this.endlessLite || !a || this._endlessT < (c.startTime || 420) || amount <= 0) return;
    a.damage.push({ t: this._endlessT, d: amount });
  },
  recordEndlessEnemyLife(e) {
    const c = CONFIG.endless.dynamicHp || {}, a = this._endlessAdaptiveHp;
    if (!this.endless || this.endlessLite || !a || this._endlessT < (c.startTime || 420) || e.isBoss || e._endlessSpawnT == null) return;
  ...
  recordEndlessBossDeath(b) {
    ...
    if (!this.endless || this.endlessLite || !a || this._endlessT < start || b._endlessSpawnT == null) return;
  ...
  updateEndlessDynamicHp() {
    ...
    if (!this.endless || this.endlessLite || !a || this._endlessT < a.next) return;
  ...
  endlessEnemyHpMult() {
    ...
    if (!this.endlessLite && e.enemyHpLateTime != null && this._endlessT > e.enemyHpLateTime) mult *= Math.pow(2, (this._endlessT - e.enemyHpLateTime) / (e.enemyHpLateDoubleInterval || e.enemyHpDoubleInterval || 120));
  ...
  endlessEnemyHpFloor() {
    ...
    if (!this.endlessLite && e.enemyHpLateTime != null && this._endlessT > e.enemyHpLateTime) floor *= Math.pow(2, (this._endlessT - e.enemyHpLateTime) / (e.enemyHpFloorLateDoubleInterval || e.enemyHpFloorDoubleInterval || 180));
