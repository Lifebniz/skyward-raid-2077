...
const CONFIG = {
  ...
  chips: {
    ...
    chargeCore: { name: "蓄能核心", desc: "蓄力更快,冷却更短", color: "#ffd43b", duration: 10, chargeRate: 1.32, cooldownMult: 0.70, boostBonus: 2 },
    capacitor: { name: "电容护盾", desc: "过载层可抵消伤害", color: "#74c0fc", duration: 14, block: 18 },
  ...
  bonuses: {
    ...
    repairLoop: { name: "维修循环", desc: "每14秒恢复5%最大生命,满血转临时护盾", color: "#38d9a9", rarity: "稀有", weight: 36, every: 14, healPct: 0.05, shield: 6, maxShield: 30, dur: 5 },
    ...
    livingArmor: { name: "活性装甲", desc: "每12次非炸弹击杀永久最大生命 +2,每层最多 +24", color: "#2f9e44", rarity: "稀有", weight: 38, every: 12, hp: 2, maxHp: 24 },
    medicalReservoir: { name: "医疗储备", desc: "满血拾取治疗补给永久最大生命 +1,每层最多 +20", color: "#38d9a9", rarity: "稀有", weight: 36, hp: 1, maxHp: 20 },
    ...
    missileInterceptor: { name: "拦截爆破", desc: "导弹爆炸会清除爆点附近敌弹", color: "#ff922b", rarity: "稀有", weight: 32, rangeMult: 0.80 },
    ...
    emergencyBarrier: { name: "应急力场", desc: "低血量受伤自动展开护盾", color: "#74c0fc", rarity: "史诗", weight: 14, threshold: 0.35, shield: 22, maxShield: 56, dur: 6, cooldown: 18 },
