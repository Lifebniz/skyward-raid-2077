...
const CONFIG = {
  ...
  bonuses: {
    ...
    leech: { name: "吸能核心", desc: "击杀回复 1 生命,冷却 1 秒", color: "#e64980", heal: 1, cooldown: 1 },
    ...
    perfectLine: { name: "完美航线", desc: "8秒未受击后伤害 +14%,射速 +8%", color: "#69db7c", rarity: "稀有", weight: 30, delay: 8, damageMult: 0.14, cooldownMult: 0.08 },
