...
assert.strictEqual(CONFIG.endless.enemyHpFloorMax, 22000, "late enemy HP floor should leave room for post-7m pressure");
...
assert(game.endlessEnemyHpMult() > CONFIG.endlessDifficulties.hell.enemyHpBoostMult * 4, "post-7m endless enemies should exceed the old doubled curve");
