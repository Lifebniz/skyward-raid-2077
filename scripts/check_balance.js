...
assert.strictEqual(CONFIG.overflow.powerDamageStep, 1, "overflow power damage should add 1 damage per overflow pickup");
...
approx(game.player.powerDamage, CONFIG.overflow.powerDamageStep, 1e-9, "overflow power should add power damage");
approx(game.mainBulletDamage(null, "main"), mainDamageBeforePower + CONFIG.overflow.powerDamageStep, 1e-9, "overflow power should increase main gun damage");
...
approx(new PlayerLaser(100, 100, 0).damage, laserDamageBeforePower + CONFIG.overflow.powerDamageStep, 1e-9, "overflow power should increase laser damage");
